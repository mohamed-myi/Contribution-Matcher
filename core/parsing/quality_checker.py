...
def check_issue_quality(issue: dict, repo_metadata: dict | None = None) -> tuple[bool, list[str]]:
    """
...
def validate_repo_quality(repo_metadata: dict | None) -> tuple[bool, list[str]]:
...
def filter_issues_by_quality(
    issues: list[dict], repo_metadata_map: dict | None = None
) -> list[dict]:
