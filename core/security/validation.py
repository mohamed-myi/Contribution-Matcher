...
def validate_encryption_key(key: Optional[str]) -> Tuple[bool, Optional[str]]:
    """
...
def validate_cors_origins(origins: str) -> Tuple[bool, Optional[str], Optional[str]]:
    """
    ...
    if has_localhost and os.getenv("ENV") == "production":
        return True, None, "CORS includes localhost origins - verify this is intentional in production"
    
    return True, None, None


def validate_database_url(url: str) -> Tuple[bool, Optional[str], Optional[str]]:
    """
